...
///
/// Delete the emoji you wrote
///
typedef void OnPressDelete();
...
class EmojiPicker extends StatefulWidget {
  ...
  /// The function delete the you wrote  Sabri Ne Gabak Adamsın La
  ...
  /// text to be shown as hint og the emoji-search field
  ...
  EmojiPicker({
    ...
    this.noRecentsStyle = const TextStyle(fontSize: 20, color: Colors.white54),
    this.categoryIcons = const CategoryIcons(),
    this.bgBarColor,
    this.buttonMode = ButtonMode.MATERIAL,
    this.hintText = "Search Emojies"
          ...
          child: widget.buttonMode == ButtonMode.MATERIAL
              ? FlatButton(
                      ...
                      children: <Widget>[
                        Icon(
                          ...
                          color: selectedCategory ==
                              ...
                              : (categoryValue==Category.RECENT)?Colors.red:widget.categoryIcons.recentIcon.color,
                        ),
                        SizedBox(height: 6),
                        Container(
                  ...
                  onPressed: () {
                      ...
                      if(categoryValue==Category.RECENT){
...
class CategoryIcons {
  ...
  const CategoryIcons(
      ...
      this.recentIcon = const CategoryIcon(icon: Icons.backspace),
